...
package 
{
	...
	public class LayoutSample7 extends Sprite
	{
		public function LayoutSample7()
		{
			...
			videoLayout.bottom=10;
			videoLayout.percentHeight=80;
			videoLayout.percentWidth=80;
			videoLayout.horizontalAlign = HorizontalAlign.RIGHT;
