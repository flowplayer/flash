...
package org.osmf.vpaid.events
{
	...
	public class VPAIDLoadEvent extends Event
	{
		public function VPAIDLoadEvent(type:String, bubbles:Boolean=false, cancelable:Boolean=false)
		{
			super(type, bubbles, cancelable);
		}
		
		public static const INITIALIZE_VPAID:String = "InitalizeVPAID";
		public static const VPAID_READY:String = "VPAIDReady";
	}
}
