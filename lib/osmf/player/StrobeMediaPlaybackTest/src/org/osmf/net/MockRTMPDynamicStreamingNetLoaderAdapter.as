...
package org.osmf.net
{
	...
	public class MockRTMPDynamicStreamingNetLoaderAdapter extends RTMPDynamicStreamingNetLoaderAdapter
	{
		/**
		 * Constructor
		 */ 
		public function MockRTMPDynamicStreamingNetLoaderAdapter(playbackOptimizationManager:PlaybackOptimizationManager)
		{
		...
		{
			return new MockNetStream(connection);
		}
	}
}