	...
	public class InsufficientBandwidthRule extends SwitchingRuleBase
	{
		...
		override public function getNewIndex():int
		{
        	...
        	if (rtmpMetrics.averageMaxBytesPerSecond != 0) 
        	{
				...
				{
					//debug("bw: " + (rtmpMetrics.averageMaxBytesPerSecond * 8 / 1024) + " multiplied: " + (rtmpMetrics.resource.streamItems[i].bitrate * bitrateMultiplier));
				...
				CONFIG::LOGGING
				{
					...
					{
						debug("Average bandwidth of " + Math.round(rtmpMetrics.averageMaxBytesPerSecond * 8 / 1024) + " < " + bitrateMultiplier + " * rendition bitrate");
					}
	        	}
        	} 
